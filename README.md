...
1. Run `schedule_visualizer.py` (double-clicking on it should run it)
2. Select the courses Excel file that you just saved (likely titled *View_My_Courses.xlsx*)
